...
k=8
S = np.load("E:博士成果/NIPS论文/SEED/Structure/S{}.npy".format(k), allow_pickle=True).item()

DE1 = np.load("E:/博士成果/NIPS论文/SEED/DE/1/{}.npy".format(k))
DE2 = np.load("E:/博士成果/NIPS论文/SEED/DE/2/{}.npy".format(k))
DE3 = np.load("E:/博士成果/NIPS论文/SEED/DE/3/{}.npy".format(k))

PCC1 = np.load("E:/博士成果/NIPS论文/SEED/PCC/1/{}.npy".format(k))
PCC2 = np.load("E:/博士成果/NIPS论文/SEED/PCC/2/{}.npy".format(k))
PCC3 = np.load("E:/博士成果/NIPS论文/SEED/PCC/3/{}.npy".format(k))

# print(DE1.shape, DE2.shape, DE3.shape)
# print(PCC1.shape, PCC2.shape, PCC3.shape)

session1 = np.concatenate([np.full((235,1), 2), np.ones([233, 1]), np.zeros([206, 1]), np.zeros([238, 1]), np.ones([185, 1]), np.full((195,1), 2), np.zeros([237, 1]),
                          np.ones([216, 1]), np.full((265,1), 2), np.full((237,1), 2), np.ones([235, 1]), np.zeros([233, 1]), np.ones([235, 1]), np.full((238,1), 2),
                          np.ones([206, 1])])

session2 = np.concatenate([np.full((235,1), 2), np.ones([233, 1]), np.zeros([206, 1]), np.zeros([238, 1]), np.ones([185, 1]), np.full((195,1), 2), np.zeros([237, 1]),
                          np.ones([216, 1]), np.full((265,1), 2), np.full((237,1), 2), np.ones([235, 1]), np.zeros([233, 1]), np.ones([235, 1]), np.full((238,1), 2),
                          np.ones([206, 1])])

session3 = np.concatenate([np.full((235,1), 2), np.ones([233, 1]), np.zeros([206, 1]), np.zeros([238, 1]), np.ones([185, 1]), np.full((195,1), 2), np.zeros([237, 1]),
                          np.ones([216, 1]), np.full((265,1), 2), np.full((237,1), 2), np.ones([235, 1]), np.zeros([233, 1]), np.ones([235, 1]), np.full((238,1), 2),
                          np.ones([206, 1])])
