...
opt = torch.optim.Adam(myModel.parameters(), lr=learning_rate, weight_decay=0.07)
...
for i in range(epoch):
    ...
    #     torch.save(myModel.state_dict(), 'E:/博士成果/NIPS论文/My_fatigue/跨会话结果/12_3/S{}.pkl'.format(k))
